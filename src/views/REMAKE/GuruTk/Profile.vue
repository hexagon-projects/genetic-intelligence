...
<template>
    <Layout>
        <div
            class="w-full p-4 md:px-12 md:py-6 lg:px-16 lg:py-8 xl:px-20 xl:py-10 flex flex-col md:flex-row md:items-start gap-4 md:gap-6 font-sora bg-[#F6F6F6] min-h-screen">
            <!-- Profile -->
            <div
                class="w-full md:w-[25%] p-3 md:p-6 rounded-3xl bg-white space-y-3 md:space-y-8 shadow-md shadow-black/5">
                <div class="w-full flex items-center">
                    <img src="" alt="" class="w-36 h-36 rounded-full mx-auto border border-[#CBCBFD]">
                </div>

                <div class="space-y-2 text-center">
                    <h2 class="font-bold text-2xl">Dulce Culhane</h2>
                ...
                <div class="space-y-2">
                    <div
                        class="p-4 rounded-full hover:bg-[#D8D8FE] group transition-all duration-500 flex items-center gap-2">
                            ...
                            <g clip-path="url(#clip0_3752_841)">
                                ...
                                <g mask="url(#mask0_3752_841)">
                                    <path
                                        ...
                                        fill="url(#paint0_linear_3752_841)" />
                                    <path
                                        ...
                                        fill="url(#paint1_linear_3752_841)" />
                                </g>
                            </g>
                            <defs>
                        ...
                        <p class="text-[#8E8E8E] group-hover:text-primary transition-all duration-500 text-sm md:text-base">Informasi Pribadi
                        </p>
                    </div>
                    ...
                    <div
                        ...
                        <p class="text-[#8E8E8E] group-hover:text-primary transition-all duration-500 text-sm md:text-base">Report
                            Pertumbuhan Anak
                        </p>
                    </div>
                </div>
            ...
            <!-- Isi Konten Tab Informasi -->
            <div class="w-full md:w-[75%] bg-white shadow-md shadow-black/5 p-6 rounded-3xl">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-6">
                    ...
                    <div class="space-y-2 flex flex-col">
                        <label for="" class="text-[#8E8E8E] text-sm">Nama Guru</label>
                        <input type="text" class="p-3 rounded-lg bg-[#F5F5F5]">
                    </div>
                </div>
            </div>
