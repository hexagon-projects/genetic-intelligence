        ...
        <div class="p-4 space-y-4 md:space-y-6">
            ...
            <div v-if="showDetailModal" class="fixed inset-0 z-50 overflow-y-auto" @click="closeDetailModal">
                <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                    ...
                    <!-- Modal content -->
                    <div @click.stop
                        class="inline-block w-full max-w-md mx-auto my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl">
                        <!-- Modal Header -->
                        ...
                        <div class="px-6 py-4 bg-gray-50/50 border-t border-gray-100">
                            <div class="flex justify-end gap-3">
                                ...
                                <button
                                    class="px-4 py-2 bg-primary text-white text-sm font-medium rounded-lg hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-1 transition-colors">
                                    Isi Kuisioner
                                </button>
                            </div>
                        </div>
