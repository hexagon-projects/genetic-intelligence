...
const arrAssessment = ref([
  { kategori: "Visual", persentase: "30%", color: "bg-[#8098F9]" },
  { kategori: "Auditori", persentase: "10%", color: "bg-[#444CE7]" },
  { kategori: "Kinestik", persentase: "15%", color: "bg-[#6172F3]" },
  { kategori: "Visual & Auditori", persentase: "15%", color: "bg-[#6172F3]" },
  { kategori: "Visual & Kinestetik", persentase: "15%", color: "bg-[#6172F3]" },
  {
...
const arrIq = ref([
  { kategori: "> 119", persentase: "30%", color: "bg-[#175CD3]" },
  { kategori: "111 - 119", persentase: "10%", color: "bg-[#1570EF]" },
  { kategori: "91 - 110", persentase: "15%", color: "bg-[#2E90FA]" },
  { kategori: "80 - 90", persentase: "15%", color: "bg-[#53B1FD]" },
  { kategori: "< 80", persentase: "15%", color: "bg-[#84CAFF]" },
]);
</script>
