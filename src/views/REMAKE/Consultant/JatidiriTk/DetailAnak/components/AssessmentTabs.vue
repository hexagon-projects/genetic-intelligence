...
<template>
    <div class="flex-col flex">
        <div class="flex">
            ...
            <!-- Tab Kognisi -->
            <div class="flex items-center gap-2 px-4 py-2 cursor-pointer transition-all duration-300"
                :class="activeResultTab === 'kognisi' ? 'bg-[#f5f5f5] rounded-t-xl' : ''" @click="changeTab('kognisi')">
                ...
                <p class="text-xs" :class="activeResultTab === 'kognisi' ? 'text-[#6464FA]' : 'text-[#8E8E8E]'">Kognisi
                </p>
            </div>
            ...
            <div class="flex items-center gap-2 px-4 py-2 cursor-pointer transition-all duration-300"
                ...
                <p class="text-xs" :class="activeResultTab === 'relasiSosial' ? 'text-[#6464FA]' : 'text-[#8E8E8E]'">
                    Relasi
                    Sosial</p>
            </div>
