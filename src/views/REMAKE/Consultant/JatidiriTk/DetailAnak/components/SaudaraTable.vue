...
const saveSaudara = async () => {
    ...
    try {
        ...
        formDataToSend.append('customer_id', props.customerId);
        formDataToSend.append('type', formData.value.type);
        formDataToSend.append('name', formData.value.name);
        formDataToSend.append('birth_date', formData.value.birth_date);
        formDataToSend.append('kewarganegaraan', formData.value.kewarganegaraan);
        formDataToSend.append('religion', formData.value.religion);
        formDataToSend.append('anak_ke', formData.value.anak_ke);
        formDataToSend.append('jumlah_sodara', formData.value.jumlah_sodara);
        formDataToSend.append('pendidikan', formData.value.pendidikan);
        formDataToSend.append('pekerjaan', formData.value.pekerjaan);
