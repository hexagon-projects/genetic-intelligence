...
const props = defineProps({
    ...
    getQuizDataByCategory: Function,
        ...
        <div class="flex-col flex">
            <div class="flex">
                ...
                <div class="flex items-center gap-2 px-4 py-2 cursor-pointer transition-all duration-300"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="13" height="12" viewBox="0 0 13 12" fill="none">
                        <g clip-path="url(#clip0_3700_13523)">
                            ...
                            <path
                                d="M10.079 9.9145C9.99002 10.0925 9.97538 10.2985 10.0383 10.4872C10.1012 10.676 10.2365 10.832 10.4145 10.921C10.5925 11.01 10.7985 11.0246 10.9872 10.9617C11.176 10.8988 11.332 10.7635 11.421 10.5855C11.4651 10.4974 11.4913 10.4015 11.4983 10.3032C11.5053 10.2049 11.4929 10.1062 11.4617 10.0128C11.4305 9.9193 11.3813 9.83289 11.3167 9.75847C11.2522 9.68404 11.1736 9.62306 11.0855 9.579C10.9974 9.53494 10.9015 9.50867 10.8032 9.50169C10.7049 9.49470 10.6062 9.50714 10.5128 9.53830C10.4193 9.56945 10.3329 9.61871 10.2585 9.68326C10.1840 9.74781 10.1231 9.82638 10.079 9.9145ZM10.079 9.9145L8.421 9.0855M8.421 9.0855C8.34543 9.2366 8.22105 9.35775 8.06802 9.42934C7.915 9.50093 7.74228 9.51875 7.57786 9.47993C7.41344 9.44110 7.26694 9.34790 7.16210 9.21542C7.05726 9.08294 7.00022 8.91894 7.00022 8.75C7.00022 8.58106 7.05726 8.41706 7.16210 8.28458C7.26694 8.15210 7.41344 8.05890 7.57786 8.02007C7.74228 7.98125 7.915 7.99907 8.06802 8.07066C8.22105 8.14225 8.34543 8.26340 8.421 8.4145M8.421 9.0855C8.4731 8.98133 8.50022 8.86647 8.50022 8.75C8.50022 8.63353 8.4731 8.51867 8.421 8.4145M10.079 7.5855C10.1226 7.67437 10.1833 7.75373 10.2577 7.81901C10.3322 7.88429 10.4187 7.93419 10.5125 7.96585C10.6063 7.99750 10.7054 8.01028 10.8042 8.00344C10.9029 7.99660 10.9993 7.97028 11.0879 7.92600C11.1764 7.88172 11.2553 7.82035 11.32 7.74544C11.3847 7.67053 11.4339 7.58355 11.4648 7.48952C11.4958 7.39549 11.5078 7.29627 11.5001 7.19758C11.4925 7.09889 11.4655 7.00268 11.4205 6.9145C11.3306 6.73820 11.1747 6.60458 10.9867 6.54276C10.7987 6.48094 10.5938 6.49593 10.4169 6.58446C10.2399 6.67299 10.1050 6.82788 10.0417 7.01539C9.97846 7.20290 9.99185 7.40782 10.079 7.5855ZM10.079 7.5855L8.421 8.4145M8.5 2.75L8.45 2.595C8.2025 1.825 8.079 1.44 7.7845 1.22C7.4895 1 7.0985 1 6.315 1H6.1835C5.401 1 5.0095 1 4.715 1.22C4.42 1.44 4.2965 1.825 4.049 2.595L4 2.75"
                                :stroke="activeResultTab === 'kognisi' ? '#6464FA' : '#8E8E8E'" />
                        </g>
                        <defs>
                ...
                <div class="flex items-center gap-2 px-4 py-2 cursor-pointer transition-all duration-300"
                    ...
                    <p class="text-xs" :class="activeResultTab === 'emosi' ? 'text-[#6464FA]' : 'text-[#8E8E8E]'">Emosi
                    </p>
                </div>
