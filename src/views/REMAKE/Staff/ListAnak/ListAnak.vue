<template>
    <div v-if="loading" class="preloader-overlay min-h-screen flex justify-center items-center">
      <span
        ...
        <div class="flex flex-col gap-[36px]">
          <div class="flex justify-between items-center mb-5">
            <div class="text-[#32324D] font-['Roboto'] leading-loose">
              <div class="text-xl md:text-3xl font-semibold">List Anak</div>
                ...
                >
                  ...
                  <tbody v-for="(siswa, index) in listSiswa" :key="index">
                    <tr class="border-b">
                      ...
                      <td class="py-3 px-4">
                        <button @click="navigateToDetail(siswa.id)"
