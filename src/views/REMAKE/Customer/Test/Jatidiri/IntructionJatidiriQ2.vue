<template>
  ...
  <Layout v-if="!loading">
    ...
    >
      ...
      <span
        >Pilihlah jawaban yang paling sesuai dengan kondisi Anda saat ini dengan
        memilih jawaban pada salah satu pilihan berikut:</span
      >
      <div class="perposed">
      ...
      <div class="w-full outline outline-1 outline-[#3030f8] rounded-lg p-5">
        ...
        >
          <div>1. Saya memahami tujuan hidup saya dengan jelas.</div>
...
const getUserData = async () => {
  try {
    ...
    isTested.value = userData.data.customer.customers_q2 == null ? false : true;
...
const handleNextQuestion = () => {
  if (isChecked.value) {
    router.push({ name: "user.views.test_q2_soal" });
  }
};
