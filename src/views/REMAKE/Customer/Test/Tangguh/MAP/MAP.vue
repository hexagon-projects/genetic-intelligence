...
const navigateToResult = () => {
    if (testHistory.value.length > 0) {
        ...
        localStorage.setItem('map_id', latestResult.id)
...
const viewTestResult = (result: any) => {
    ...
    localStorage.setItem('map_id', result.id)
    router.push(`/tangguh/map/hasil`);
};
        ...
        <div class="w-full min-h-screen p-4 space-y-6 md:max-w-[50%] lg:max-w-[30%] xl:max-w-[25%] mx-auto relative">
            <div v-if="hasTestResult" class="min-h-screen flex flex-col justify-center items-center">
                <div class="text-center mb-8">
                    <h1 class="text-xl font-bold text-[#6464FA] mb-4">Hasil Tes Jatidiri Tangguh - MAP</h1>
                ...
                <div class="w-full md:max-w-lg">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="space-y-6">
                            <div v-for="(result, index) in testHistory" :key="result.map.id" class="w-full h-20 md:h-24"
