            ...
            <div class="mx-[30px] md:mx-[312px] bg-white flex flex-row items-center justify-center">
                <div class="flex flex-col items-center gap-[56px]">
                    <div class="flex flex-col items-center gap-[27px]">
                        <span class="text-[#3030f8] text-base lg:text-lg font-bold font-['Roboto'] leading-7">STARTER PACK</span>
                        
                        <div class="flex flex-col items-center gap-[14px]">
                            <h1 class="text-center text-[#170f49] text-2xl lg:text-4xl font-bold font-roboto leading-[62px]">
                                Solusi Instan untuk Eksplorasi Diri
                            </h1>
                            <span class="text-center text-[#6e6b8f] text-sm lg:text-base font-normal font-['Roboto'] leading-normal">Dapatkan akses ke semua tes dengan satu kali pembayaran dan mulai jelajahi potensi diri kamu sekarang juga.</span>
                        </div>
                    </div>

                    <div v-if="!isPaymentStatus" class="shadow-sm grid grid-cols-1 md:grid-cols-2 bg-[#f7f7fc] rounded-[20px] p-1">
                        <div class="bg-white rounded-tl-[16px] rounded-tr-[16px] lg:rounded-tr-none lg:rounded-s-[16px] px-14 py-[74px]">
                            <div class="flex flex-col gap-[24px]">
                                <div class="flex flex-col gap-[18px]">
                                    ...
                                    <span class="w-[287px] text-[#6e6b8f] text-base font-normal font-roboto leading-[30px]">Mulai Sekarang dan Hemat Lebih Banyak! Hanya :</span>
                                </div>
                                ...
                                <div>
                                    <RouterLink :to="{path: '/pembayaran/starter-pack'}" class="hover:shadow-2xl hover:translate-x-1 transition-all h-11 pl-6 pr-4 py-1.5 bg-[#3030f8] rounded-full justify-center items-center gap-3 inline-flex">
                                        <div class="text-white text-base font-normal font-['Roboto'] leading-normal">Beli Sekarang</div>
                        ...
                        <div class="flex flex-col justify-center rounded-s-[16px] px-14 py-[74px]">
                            <div class="flex flex-col justify-center gap-[24px]">
                                <div class="flex flex-col gap-[24px]">
                                    <h1 class="text-[#170f49] text-lg font-bold font-roboto leading-tight">What’s included</h1>

                                    <div class="flex flex-col gap-[16px]">
                                        <div v-for="(item, index) in testLists" :key="index" class="w-full flex items-center gap-2">
                    ...
                    <div v-if="isPaymentStatus" class="shadow-sm w-[789px] grid grid-cols-1 md:grid-cols-2 bg-[#f7f7fc] rounded-[20px] p-1">
                        <div class="bg-white rounded-tl-[16px] rounded-tr-[16px] lg:rounded-tr-none lg:rounded-s-[16px] px-14 py-[74px]">
                            <div class="flex flex-col gap-[24px]">
                                <div class="flex flex-col gap-[18px]">
                                    <div class="flex items-center gap-3">
                                        <img class="w-14 h-14" src="@/assets/icons/starter_pack/pack.svg" alt="icon">
                                        <h1 class="text-[#170f49] text-2xl font-bold font-['Roboto'] leading-normal">Starter Pack Kamu Telah Aktif!</h1>
                                    </div>

                                    <div class="w-[307px] text-[#6e6b8f] text-base font-normal font-['Roboto'] leading-normal">
                                        Selamat! Kamu sekarang memiliki akses penuh ke semua tes. Jelajahi tes yang tersedia dan mulai perjalananmu untuk mengenal dirimu lebih baik!
                                    </div>
                                </div>
                            </div>
                        </div>
