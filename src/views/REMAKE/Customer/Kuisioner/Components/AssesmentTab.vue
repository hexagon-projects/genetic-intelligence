    ...
    <div class="flex-col flex">
        ...
        <div class="flex flex-wrap sm:flex-nowrap overflow-x-auto scrollbar-hide">
            ...
            <div class="flex items-center gap-1 sm:gap-2 px-2 sm:px-3 md:px-4 py-2 cursor-pointer transition-all duration-300 whitespace-nowrap min-w-fit"
                :class="activeResultTab === 'kesimpulan' ? 'bg-[#f5f5f5] rounded-xl md:rounded-t-xl md:rounded-b-none' : ''"
                @click="emit('changeTab', 'kesimpulan')">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-3 h-3 sm:w-4 sm:h-4 md:w-[17px] md:h-4 flex-shrink-0"
                ...
                <p class="text-[10px] sm:text-xs"
                    :class="activeResultTab === 'kesimpulan' ? 'text-[#6464FA]' : 'text-[#8E8E8E]'">Kesimpulan</p>
            </div>
            ...
            <div class="flex items-center gap-1 sm:gap-2 px-2 sm:px-3 md:px-4 py-2 cursor-pointer transition-all duration-300 whitespace-nowrap min-w-fit"
                ...
                <p class="text-[10px] sm:text-xs"
                    :class="activeResultTab === 'psikomotor' ? 'text-[#6464FA]' : 'text-[#8E8E8E]'">Psikomotor</p>
            </div>
            ...
            <div class="flex items-center gap-1 sm:gap-2 px-2 sm:px-3 md:px-4 py-2 cursor-pointer transition-all duration-300 whitespace-nowrap min-w-fit"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" class="w-3 h-3 sm:w-4 sm:h-4 md:w-[13px] md:h-3 flex-shrink-0"
                ...
                <p class="text-[10px] sm:text-xs"
                    :class="activeResultTab === 'kognisi' ? 'text-[#6464FA]' : 'text-[#8E8E8E]'">Kognisi</p>
            </div>
            ...
            <div class="flex items-center gap-1 sm:gap-2 px-2 sm:px-3 md:px-4 py-2 cursor-pointer transition-all duration-300 whitespace-nowrap min-w-fit"
                ...
                <p class="text-[10px] sm:text-xs"
                    :class="activeResultTab === 'emosi' ? 'text-[#6464FA]' : 'text-[#8E8E8E]'">Emosi</p>
            </div>
            ...
            <div class="flex items-center gap-1 sm:gap-2 px-2 sm:px-3 md:px-4 py-2 cursor-pointer transition-all duration-300 whitespace-nowrap min-w-fit"
                ...
                <p class="text-[10px] sm:text-xs"
                    :class="activeResultTab === 'relasiSosial' ? 'text-[#6464FA]' : 'text-[#8E8E8E]'">Relasi Sosial</p>
            </div>
            ...
            <div class="flex items-center gap-1 sm:gap-2 px-2 sm:px-3 md:px-4 py-2 cursor-pointer transition-all duration-300 whitespace-nowrap min-w-fit"
                ...
                <p class="text-[10px] sm:text-xs"
                    :class="activeResultTab === 'kemandirian' ? 'text-[#6464FA]' : 'text-[#8E8E8E]'">Kemandirian</p>
            </div>
        </div>
        ...
        <transition name="fade" mode="out-in">
            <div :key="activeResultTab"
                class="p-3 md:p-4 bg-[#F5F5F5] rounded-xl md:rounded-b-xl md:rounded-tr-xl md:rounded-tl-none space-y-3 md:space-y-4">
