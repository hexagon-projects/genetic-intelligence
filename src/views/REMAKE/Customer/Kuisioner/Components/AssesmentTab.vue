    ...
    <div class="flex-col flex">
        ...
        <div class="flex flex-wrap sm:flex-nowrap overflow-x-auto scrollbar-hide">
            ...
            <div class="flex items-center gap-1 sm:gap-2 px-2 sm:px-3 md:px-4 py-2 cursor-pointer transition-all duration-300 whitespace-nowrap min-w-fit"
                ...
                <p class="text-[10px] sm:text-xs" :class="activeResultTab === 'kognisi' ? 'text-[#6464FA]' : 'text-[#8E8E8E]'">Kognisi</p>
            </div>

            <!-- Tab Emosi -->
            <div class="flex items-center gap-1 sm:gap-2 px-2 sm:px-3 md:px-4 py-2 cursor-pointer transition-all duration-300 whitespace-nowrap min-w-fit"
                :class="activeResultTab === 'emosi' ? 'bg-[#f5f5f5] rounded-xl md:rounded-t-xl md:rounded-b-none' : ''"
                @click="emit('changeTab', 'emosi')">
                <svg xmlns="http://www.w3.org/2000/svg" 
                     class="w-3 h-3 sm:w-4 sm:h-4 md:w-[13px] md:h-3 flex-shrink-0" 
                     viewBox="0 0 13 12" fill="none">
                    <path d="M2 1.8C2 1.72044 2.03161 1.64413 2.08787 1.58787C2.14413 1.53161 2.22044 1.5 2.3 1.5H10.7C10.7796 1.5 10.8559 1.53161 10.9121 1.58787C10.9684 1.64413 11 1.72044 11 1.8V8.7C11 8.7394 10.9922 8.77841 10.9772 8.81481C10.9621 8.8512 10.94 8.88427 10.9121 8.91213C10.8843 8.93999 10.8512 8.96209 10.8148 8.97716C10.7784 8.99224 10.7394 9 10.7 9H8.63C8.58897 8.99994 8.54837 9.0083 8.5107 9.02455C8.47304 9.0408 8.4391 9.06461 8.411 9.0945L6.7185 10.893C6.69045 10.9228 6.65659 10.9466 6.61902 10.9628C6.58144 10.9791 6.54094 10.9874 6.5 10.9874C6.45906 10.9874 6.41856 10.9791 6.38098 10.9628C6.34341 10.9466 6.30955 10.9228 6.2815 10.893L4.589 9.0945C4.5609 9.06461 4.52696 9.0408 4.4893 9.02455C4.45163 9.0083 4.41103 8.99994 4.37 9H2.3C2.22044 9 2.14413 8.96839 2.08787 8.91213C2.03161 8.85587 2 8.77956 2 8.7V1.8Z" :stroke="activeResultTab === 'emosi' ? '#6464FA' : '#8E8E8E'" />
                    <path d="M6.5 3.5L7.2125 4.7875L8.5 5.5L7.2125 6.2125L6.5 7.5L5.7875 6.2125L4.5 5.5L5.7875 4.7875L6.5 3.5Z" :stroke="activeResultTab === 'emosi' ? '#6464FA' : '#8E8E8E'" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
                <p class="text-[10px] sm:text-xs" :class="activeResultTab === 'emosi' ? 'text-[#6464FA]' : 'text-[#8E8E8E]'">Emosi</p>
            </div>

            <!-- Tab Relasi Sosial -->
            <div class="flex items-center gap-1 sm:gap-2 px-2 sm:px-3 md:px-4 py-2 cursor-pointer transition-all duration-300 whitespace-nowrap min-w-fit"
                :class="activeResultTab === 'relasiSosial' ? 'bg-[#f5f5f5] rounded-xl md:rounded-t-xl md:rounded-b-none' : ''"
                @click="emit('changeTab', 'relasiSosial')">
                <svg xmlns="http://www.w3.org/2000/svg" 
                     class="w-3 h-3 sm:w-4 sm:h-4 md:w-[13px] md:h-3 flex-shrink-0" 
                     viewBox="0 0 13 12" fill="none">
                    <path d="M2 1.8C2 1.72044 2.03161 1.64413 2.08787 1.58787C2.14413 1.53161 2.22044 1.5 2.3 1.5H10.7C10.7796 1.5 10.8559 1.53161 10.9121 1.58787C10.9684 1.64413 11 1.72044 11 1.8V8.7C11 8.7394 10.9922 8.77841 10.9772 8.81481C10.9621 8.8512 10.94 8.88427 10.9121 8.91213C10.8843 8.93999 10.8512 8.96209 10.8148 8.97716C10.7784 8.99224 10.7394 9 10.7 9H8.63C8.58897 8.99994 8.54837 9.0083 8.5107 9.02455C8.47304 9.0408 8.4391 9.06461 8.411 9.0945L6.7185 10.893C6.69045 10.9228 6.65659 10.9466 6.61902 10.9628C6.58144 10.9791 6.54094 10.9874 6.5 10.9874C6.45906 10.9874 6.41856 10.9791 6.38098 10.9628C6.34341 10.9466 6.30955 10.9228 6.2815 10.893L4.589 9.0945C4.5609 9.06461 4.52696 9.0408 4.4893 9.02455C4.45163 9.0083 4.41103 8.99994 4.37 9H2.3C2.22044 9 2.14413 8.96839 2.08787 8.91213C2.03161 8.85587 2 8.77956 2 8.7V1.8Z" :stroke="activeResultTab === 'relasiSosial' ? '#6464FA' : '#8E8E8E'" />
                    <path d="M6.5 3.5L7.2125 4.7875L8.5 5.5L7.2125 6.2125L6.5 7.5L5.7875 6.2125L4.5 5.5L5.7875 4.7875L6.5 3.5Z" :stroke="activeResultTab === 'relasiSosial' ? '#6464FA' : '#8E8E8E'" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
                <p class="text-[10px] sm:text-xs" :class="activeResultTab === 'relasiSosial' ? 'text-[#6464FA]' : 'text-[#8E8E8E]'">Relasi Sosial</p>
            </div>

            <!-- Tab Kemandirian -->
            <div class="flex items-center gap-1 sm:gap-2 px-2 sm:px-3 md:px-4 py-2 cursor-pointer transition-all duration-300 whitespace-nowrap min-w-fit"
                :class="activeResultTab === 'kemandirian' ? 'bg-[#f5f5f5] rounded-xl md:rounded-t-xl md:rounded-b-none' : ''"
                @click="emit('changeTab', 'kemandirian')">
                <svg xmlns="http://www.w3.org/2000/svg" 
                     class="w-3 h-3 sm:w-4 sm:h-4 md:w-[13px] md:h-3 flex-shrink-0" 
                     viewBox="0 0 13 12" fill="none">
                    <path d="M2 1.8C2 1.72044 2.03161 1.64413 2.08787 1.58787C2.14413 1.53161 2.22044 1.5 2.3 1.5H10.7C10.7796 1.5 10.8559 1.53161 10.9121 1.58787C10.9684 1.64413 11 1.72044 11 1.8V8.7C11 8.7394 10.9922 8.77841 10.9772 8.81481C10.9621 8.8512 10.94 8.88427 10.9121 8.91213C10.8843 8.93999 10.8512 8.96209 10.8148 8.97716C10.7784 8.99224 10.7394 9 10.7 9H8.63C8.58897 8.99994 8.54837 9.0083 8.5107 9.02455C8.47304 9.0408 8.4391 9.06461 8.411 9.0945L6.7185 10.893C6.69045 10.9228 6.65659 10.9466 6.61902 10.9628C6.58144 10.9791 6.54094 10.9874 6.5 10.9874C6.45906 10.9874 6.41856 10.9791 6.38098 10.9628C6.34341 10.9466 6.30955 10.9228 6.2815 10.893L4.589 9.0945C4.5609 9.06461 4.52696 9.0408 4.4893 9.02455C4.45163 9.0083 4.41103 8.99994 4.37 9H2.3C2.22044 9 2.14413 8.96839 2.08787 8.91213C2.03161 8.85587 2 8.77956 2 8.7V1.8Z" :stroke="activeResultTab === 'kemandirian' ? '#6464FA' : '#8E8E8E'" />
                    <path d="M6.5 3.5L7.2125 4.7875L8.5 5.5L7.2125 6.2125L6.5 7.5L5.7875 6.2125L4.5 5.5L5.7875 4.7875L6.5 3.5Z" :stroke="activeResultTab === 'kemandirian' ? '#6464FA' : '#8E8E8E'" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
                <p class="text-[10px] sm:text-xs" :class="activeResultTab === 'kemandirian' ? 'text-[#6464FA]' : 'text-[#8E8E8E]'">Kemandirian</p>
            </div>
        </div>
        ...
        <transition name="fade" mode="out-in">
            <div :key="activeResultTab" class="p-3 md:p-4 bg-[#F5F5F5] rounded-xl md:rounded-b-xl md:rounded-tr-xl md:rounded-tl-none space-y-3 md:space-y-4">
                <p class="text-xs sm:text-sm leading-relaxed">{{ getTabContent() }}</p>
