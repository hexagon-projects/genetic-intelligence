...
const props = defineProps({
    type: {
        type: String,
        required: true,
        validator: (value) => ['user', 'report', 'check-report'].includes(value)
    },
    active: {
        type: Boolean,
        default: false
...
<template>
    <!-- User Icon -->
    <svg v-if="type === 'user'" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
        fill="none">
        <g clip-path="url(#clip0_3752_841)">
            <mask id="mask0_3752_841" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="0" y="0" width="24"
                height="24">
            ...
            <g mask="url(#mask0_3752_841)">
                <path
                    ...
                    :fill="active ? '#6464FA' : 'url(#paint0_linear_3752_841)'" />
                <path
                    ...
                    :fill="active ? '#6464FA' : 'url(#paint1_linear_3752_841)'" />
            </g>
        </g>
        <defs>
    ...
    <!-- Check Report Icon -->
    <svg v-else-if="type === 'check-report'" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
        viewBox="0 0 24 24" fill="none">
        <!-- Mengganti stroke dengan fill untuk bagian-bagian tertentu -->
        <path
            d="M16.1749 2.81643H18.6799C19.1228 2.81643 19.5476 2.99238 19.8608 3.30556C20.174 3.61875 20.3499 4.04352 20.3499 4.48643V21.1844C20.3499 21.6273 20.174 22.0521 19.8608 22.3653C19.5476 22.6785 19.1228 22.8544 18.6799 22.8544H5.3199C5.10059 22.8544 4.88343 22.8112 4.68082 22.7273C4.47821 22.6434 4.29411 22.5204 4.13903 22.3653C3.98396 22.2102 3.86095 22.0261 3.77702 21.8235C3.6931 21.6209 3.6499 21.4037 3.6499 21.1844V4.48543C3.6499 4.04252 3.82585 3.61775 4.13903 3.30456C4.45222 2.99138 4.87699 2.81543 5.3199 2.81543H7.8249"
            :stroke="active ? '#6464FA' : '#8E8E8E'" stroke-width="1.5" stroke-linecap="round"
            stroke-linejoin="round" />
        <path
            d="M14.5049 1.14648H9.49493C9.05202 1.14648 8.62725 1.32243 8.31406 1.63562C8.00088 1.9488 7.82493 2.37357 7.82493 2.81648V3.65048C7.82493 4.57348 8.57293 5.32048 9.49493 5.32048H14.5049C14.7242 5.32048 14.9414 5.27729 15.144 5.19336C15.3466 5.10944 15.5307 4.98643 15.6858 4.83135C15.8409 4.67628 15.9639 4.49218 16.0478 4.28957C16.1317 4.08695 16.1749 3.86979 16.1749 3.65048V2.81648C16.1749 2.37357 15.999 1.9488 15.6858 1.63562C15.3726 1.32243 14.9478 1.14648 14.5049 1.14648ZM13.6939 9.47648H10.3059V12.3535H7.42993V15.7415H10.3069V18.6195H13.6949V15.7405H16.5729V12.3525H13.6949L13.6939 9.47648Z"
            :stroke="active ? '#6464FA' : '#8E8E8E'" stroke-width="1.5" stroke-linecap="round"
            stroke-linejoin="round" />
        <!-- Menambahkan plus sign dengan fill untuk konsistensi -->
        <path v-if="active"
            d="M13.6939 9.47648H10.3059V12.3535H7.42993V15.7415H10.3069V18.6195H13.6949V15.7405H16.5729V12.3525H13.6949L13.6939 9.47648Z"
            fill="#6464FA" />
    </svg>
</template>