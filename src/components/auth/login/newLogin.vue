<template>
    <div class="hidden lg:block">
      <div id="img-login" class="w-full flex items-center justify-between min-h-screen px-12 py-8 xl:py-18">
        <div class="text-white flex flex-col gap-1 ml-10">
            <h1 class="text-lg md:text-4xl lg:text-3xl font-myFont font-semibold">#TemukanJatidirimu</h1>
            <h1 class="text-2xl md:text-4xl lg:text-5xl font-myFont font-semibold lg:mb-4">Bersama Jatidiri.app</h1>
            <!-- <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Tenetur illum non error eaque adipisci inventore!</p> -->
        </div>

        <div class="bg-white bg-opacity-60 backdrop-blur-xl h-[579px] w-1/3 rounded-3xl">
            ...
            <div class="flex flex-col justify-center items-center gap-4">
                ...
                <div class="mx-auto w-full flex flex-col items-center my-3 gap-4">
                  <button v-if="isLoading" disabled="" type="button" class="font-myFont font-medium bg-biru text-white py-2 px-4 rounded-md hover:bg-blue-600 w-full lg:w-3/4 inline-flex justify-center items-center">
