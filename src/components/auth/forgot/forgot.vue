<template>
    <div id="img-login" class="w-full flex flex-row items-center justify-center min-h-screen px-4">
        <div class="flex justify-center pt-22">
            <div class="bg-white mx-4 lg:mx-auto px-10 py-4 drop-shadow-2xl rounded-lg">
                <div class="flex flex-col justify-center items-center mb-6">
                    ...
                    <div class="mt-4 w-full lg:w-1/2 mb-4">
                        ...
                        :class="{'border-danger': validasiEmail !== null, 'border-gray-300': validasiEmail == null}"
                    ...
                    <button @click="kirimEmail" :disabled="buttonDisabled"
