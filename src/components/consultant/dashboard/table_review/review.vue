<template>
    <div class="flex flex-col lg:hidden bg-white w-full p-4 rounded-lg"
    >
        ...
        <span v-else-if="dataSubmit.length == 0 && !loading" class="font-myFont text-center text-dark text-sm">
            Tidak ada test untuk di review
        </span>
    </div>
    ...
    >
        ...
        <span v-else-if="dataSubmit.length == 0 && !loading" class="font-myFont text-center text-dark text-lg mt-32">
            Tidak ada test untuk di review
        </span>
    </div>
</template>
