            ...
            <div class="flex justify-center items-center w-full gap-2">
                ...
                <div class="w-full mb-4">
                    ...
                    <select v-model="statusNikah" name="status_nikah" id="status_nikah" class="mt-1 p-2 border rounded-md w-full focus:outline-none focus:ring-biru focus:ring-2 focus:border-biru bg-white">
                        <option>-- Status Kawin ajg --</option>
                        <option v-for="(option, index) in dataStatusNikah" :key="index" :value="option.id">
                        {{ option.text }}
                        </option>
                    </select>
                </div>
...
export default {
    ...
    setup(props){
        ...
        const jenisKelamin = ref(props.dataCustomer ? props.dataCustomer.gender : '-- Jenis Kelamin --')
        const statusNikah = ref(props.dataCustomer ? props.dataCustomer.status : '-- Status Nikah --')
        ...
        const golonganDarah = ref(props.dataCustomer ? props.dataCustomer.blood_group : '')
        const agama = ref(props.dataCustomer ? props.dataCustomer.religion : '')
