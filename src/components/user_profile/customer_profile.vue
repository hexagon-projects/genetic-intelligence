<template>
  ...
  <div class="flex flex-col lg:flex-row justify-center mx-4 pt-5 gap-5">
    ...
    <div class="lg:w-1/2 flex flex-col gap-5">
      <UbahRole :dataCustomer="userData" />

      <!-- <InformasiSekolah v-if="userData.is_student == 1" :dataCustomer="userData" /> -->

      <InformasiCorporate v-if="userData.is_student == 1" :dataCustomer="userData" />
...
import UbahRole from './customer/ubah_role/ubahRole.vue'
import InformasiCorporate from './customer/informasi_sekolah/informasiCorporate.vue'

export default {
  name: 'customerProfile',
  components: { InformasiPribadi, FotoProfile, InformasiSekolah, UbahPassword, UbahRole, InformasiCorporate },
  setup() {
