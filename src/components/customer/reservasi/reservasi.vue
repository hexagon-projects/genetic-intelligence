<template>
    <Layout>
        <section class="bg-gray-100 pb-8 text-dark">
            ...
            <div v-if="isDetectedGIM == 'Belum'" class="mt-11 mx-7">
                <belumDeteksi/>
            </div>
                ...
                <div v-if="userData && dataReservasi" class="mx-7 bg-white rounded-lg shadow-lg p-4">
                    ...
                    <div v-if="userData.is_advance == 'Tidak' && reservasiData && !loading" class="flex flex-col md:flex-row lg:flex-row items-center">
                        <div class="md:w-full lg:w-1/2 mb-2">
                            ...
                            <table class="hidden lg:block lg:ml-12 w-full text-sm text-gray-500">
...
export default {
    name: 'Reservasi',
    components: {PhUser, PhTimer, PhCalendar, PilihHari, belumDeteksi, Layout},
    setup(){
