<!-- <template>
    <div class="h-[90vh] flex items-center justify-center">
        ...
        <div class="my-2 w-[430px] h-[537.72px] mx-auto px-9 flex-col justify-center items-center gap-14 inline-flex">
            <img class="w-1/2 md:w-full drop-shadow-xl" 
            src="@/assets/img/cpm/before-cpm.svg">
            ...
            <div class="h-[246px] flex-col justify-center items-center gap-6 inline-flex">
                <div class="self-stretch h-40 flex-col justify-center items-center gap-4 flex">
                    <div class="self-stretch text-center text-[#0b0b79] text-2xl font-semibold font-sora leading-9">Tes CPM (Coloured Progressive Matrices)</div>
                    <div class="self-stretch text-center text-[#667084] text-sm font-normal font-['Roboto'] leading-normal">Tes CPM ini dirancang untuk mengukur kemampuan penalaran logis dan intelegensi non-verbal Kamu!</div>
                </div>

                <button class="mb-8 hover:-translate-y-2 transition-all cursor-pointer self-stretch min-h-[42px] max-h-[62px] px-[60px] py-[18px] md:px-[90px] md:py-[18px] bg-[#3030f8] rounded-2xl border-l hover:border-l-[6px] hover:border-r-0 border-r hover:border-t-0 border-t border-b-4 hover:border-b-8 border-black justify-center items-center gap-2.5 inline-flex">
                    <div class="text-white text-base font-medium font-roboto leading-normal">Tes Sekarang</div>
...
<template>
    <div class="h-[90vh] lg:mt-12 flex items-center justify-center">
        <div class="absolute top-[68px] lg:top-0 lg:bottom-0 lg:my-auto">
            <img src="@/assets/img/cpm/gradient.png" alt="gradient">
        </div>
        <div class="my-2 w-[430px] h-[537.72px] mx-auto px-9 flex-col justify-center items-center gap-14 inline-flex">
            ...
            <div class="h-[246px] flex-col justify-center items-center gap-6 inline-flex relative z-10">
                <div class="self-stretch h-40 flex-col justify-center items-center gap-4 flex">
                    ...
                    <div class="self-stretch text-center text-[#667084] text-sm font-normal font-roboto leading-normal">
                        Tes CPM ini dirancang untuk mengukur kemampuan penalaran logis dan intelegensi non-verbal Kamu!
                    </div>
                </div>
...
const emit = defineEmits(['siapTest'])
