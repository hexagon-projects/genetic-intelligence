<template>
    <div class="justify-center w-full lg:w-[30%] flex flex-col items-center">
        <div class="px-9 py-6 bg-white rounded-3xl border-l border-r border-t border-b border-[#667084] flex-col justify-start items-center gap-3 inline-flex">
            ...
            <div class="justify-center items-start gap-3 inline-flex">
                <div class="w-6 h-6 relative">
                    <img src="@/assets/img/cpm/Check.svg" alt="check">
                </div>
    ...
    <!-- <div class="mt-6 lg:mt-0 h-[404px] px-9 py-6 bg-white rounded-3xl border-l border-r border-t border-b border-[#667084] flex-col justify-start items-center gap-3 inline-flex">
        ...
        <div class="w-[302px] justify-center items-start gap-3 inline-flex">
            <div class="w-6 h-6 relative">
                <img src="@/assets/img/cpm/Check.svg" alt="check">
            </div>
            <div class="grow shrink basis-0">
