<template>
    <div class="justify-center w-full lg:w-[30%] flex flex-col items-center ">
        <div class="w-full flex-col justify-start items-start inline-flex">
            <div class="w-full px-9 py-4 bg-gradient-to-b from-[#aa67ff] to-[#5959f9] rounded-tl-3xl rounded-tr-3xl border border-black flex-col justify-start items-center gap-3 flex">
                <div class="text-white text-xl font-medium font-['Roboto'] leading-7">Identitas</div>
            </div>

            <div class="w-full px-9 py-6 rounded-bl-3xl rounded-br-3xl border border-black flex flex-col gap-2 text-[#667084] text-sm font-normal font-roboto leading-tight">
                <!-- Nama -->
