<template>
  <div v-if="props.siswaDatas.customer_mapping !== null" class="w-full py-5 bg-white">
      <!-- Header Section -->
      <div
      ...
      >
        <div class="flex-1">
          ...
          <p
            v-if="siswaDatas.customer_mapping && siswaDatas.customer_mapping.top7 && siswaDatas.customer_mapping.top7.length > 0"
            class="text-gray-700 mb-6 max-w-2xl"
          >
            {{ siswaDatas.customer_mapping.top7[0].claster }}
          </p>
          ...
          <div class="mb-12">
            ...
            >
              <button
                v-for="(item, index) in siswaDatas.customer_mapping.top7"
                :key="index"
          ...
          <div class="mb-12">
            ...
            <!-- Jika data sudah ada -->
            <div
              v-if="siswaDatas.customer_mapping && siswaDatas.customer_mapping.bottom7 && siswaDatas.customer_mapping.bottom7.length > 0"
              class="flex flex-wrap gap-3"
            >
              <button
                v-for="(item, index) in siswaDatas.customer_mapping.bottom7"
                :key="index"
      ...
      <div>
        ...
        <div
          v-if="
            siswaDatas.customer_mapping && siswaDatas.customer_mapping.cluster_result && siswaDatas.customer_mapping.cluster_result.length > 0
          "
          class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6"
        >
          <div
            class="border rounded-lg p-6 shadow-sm flex flex-col"
            v-for="(item, index) in siswaDatas.customer_mapping.cluster_result"
            :key="index"
          >
