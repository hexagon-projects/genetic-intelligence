<template>
    <div class="w-full lg:w-1/2">
        <div class="bg-white rounded-lg shadow-sm p-2 lg:p-0 lg:py-2 w-full h-full overflow-hidden">
            <div class="flex flex-col items-center gap-2 lg:gap-4 lg:mx-auto lg:w-3/4">
                ...
                <h1 class="text-xl font-myFont text-dark font-semibold">{{ userResultDetect.gim.name }}</h1>
    ...
    <div class="w-full lg:w-1/2">
        <div class="flex flex-col gap-4 lg:gap-4">
            <div class="bg-white rounded-lg shadow-sm lg:p-2 w-full h-full overflow-hidden">
