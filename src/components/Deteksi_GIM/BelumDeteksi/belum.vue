        ...
        <div class="hidden lg:flex lg:flex-row items-center">
            <div class="lg:w-1/2">
                <div class="flex flex-col mx-14">
                    <h1 class="font-myFont lg:text-3xl text-2xl text-start text-dark font-semibold">Siap-siap ya—dalam waktu dekat bisa langsung kamu coba!</h1>
                    <!-- <h1 class="font-myFont lg:text-3xl text-2xl text-start text-dark font-semibold">Kamu belum melakukan test <span class="italic">Jatidiri Sejati</span>.</h1> -->
                    <p class="font-myFont text-start text-dark-500 text-sm mb-4">Fitur ini akan segera hadir untuk membantumu memetakan karakter, potensi, dan kebutuhan psikologismu.</p>
