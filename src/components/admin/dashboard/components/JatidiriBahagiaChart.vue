...
const overallPercentage = computed(() => {
    if (!statisticsData.value['Tingkat Kebahagiaan Sangat Tinggi']) return 0
    return Math.round((statisticsData.value['Tingkat Kebahagiaan Sangat Tinggi'].value / totalResponses.value) * 100)
})
