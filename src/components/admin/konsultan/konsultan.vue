<template>
    <section class="bg-gray-100 pb-28">
        ...
        <div v-if="isModalOpen && detailCustomers"
            ...
            <div class="hidden lg:block relative w-3/4 top-4 mx-auto shadow-xl rounded-md bg-white">
                ...
                <div class="flex flex-row">
                    <img v-if="detailCustomers.image !== null" class="w-[400px] h-[400px] p-4"
                        :src="baseUrl + 'open/consultant/' + detailCustomers.image" alt="">
                    <img v-if="detailCustomers.image == null" class="w-1/2 h-3/4 p-4" src="https://placehold.co/400x400"
                        alt="">
                ...
                <div class="px-4 py-2 flex justify-end items-center space-x-4">
                    <button class="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-700 transition"
                        @click="toggleModal">Tutup</button>
                </div>
            </div>
            ...
            <div class="block lg:hidden relative w-full top-4 mx-auto shadow-xl rounded-md bg-white">
                ...
                <div class="flex flex-col justify-center items-center">
                    <img v-if="detailCustomers.image !== null" class="w-[180px] h-[180px] p-4"
                        :src="baseUrl + 'open/consultant/' + detailCustomers.image" alt="">
                    <img v-if="detailCustomers.image == null" class="w-[180px] h-[180px] p-4"
        ...
        <div class="flex flex-col lg:flex-row justify-center mx-4 mb-4 pt-4 pb-10 gap-4">
            <div class="w-full px-7 mx-auto">
                <div class="flex flex-col bg-white w-full p-6 rounded-lg shadow-lg">
                    ...
                    <div
                        class="flex flex-col md:flex-row md:items-center md:justify-between lg:flex-row lg:items-center lg:justify-between">
                        <div class="flex items-center gap-4">
                            <div class="relative inline-block text-left">
                                <div class="flex items-center gap-1">
                                    <RouterLink :to="{ name: 'admin.views.konsultan.register' }" type="button"
                                        class="mb-2 md:mb-0 lg:mb-0 font-myFont flex w-full justify-center items-center gap-x-1.5 rounded-md bg-biru px-3 py-2 text-sm font-medium text-light hover:bg-opacity-75 hover:shadow-md">
                                        <PhPlus :size="20" />
                            ...
                            <div class="flex items-center gap-1">
                                <RouterLink :to="{ name: 'admin.views.konsultan.pending' }" type="button"
                                    class="mb-2 md:mb-0 lg:mb-0 font-myFont flex w-full justify-center items-center gap-x-1.5 rounded-md bg-biru px-3 py-2 text-sm font-medium text-light hover:bg-opacity-75 hover:shadow-md">
                                    Pendaftar Konsultan
                                </RouterLink>
                            </div>
                        ...
                        <input v-model="cari" @input="() => debouncedGetSearchData()" type="text" name="cari"
                            class="mb-2 font-myFont rounded-md border border-gray-300 py-2 px-3"
                        ...
                        <table class="w-full text-sm text-left text-gray-500">
                            ...
                            <tbody>
                                <tr v-for="(data, index) in dataCustomer" :key="index" class="bg-white border-b">
                                    ...
                                    <td class="py-4 px-6">
                                        <button @click="clickDetail(data.id)"
                                            class="flex items-center gap-1 px-4 py-2 bg-biru font-myFont text-sm text-white rounded-lg hover:bg-opacity-75 hover:shadow-lg">
                    ...
                    <span v-else-if="dataCustomer.length == 0 && !loading"
                        class="font-myFont text-center text-dark text-lg">Data kosong</span>
                    <div class="flex justify-between items-center mt-4">
                        <span class="font-myFont text-xs md:text-sm lg:text-sm text-start lg:text-center text-dark">
                            {{ totalDari == null ? 0 : totalDari }} sampai {{ totalKe == null ? 0 : totalKe }} dari {{
                                totalData }} data.
                        </span>
                        <a class="flex items-center font-myFont text-dark text-xs lg:text-base">
                            Halaman
                            <div class="mx-2 flex items-center gap-1">
                                <a @click="nextPages(nextPage)"
                                    class="cursor-pointer text-sm md:text-base lg:text-xl text-dark text-opacity-70 hover:text-opacity-100 hover:shadow-sm">
                                    <PhCaretLeft />
                                </a>
                                <span class="px-2 py-1 border rounded-lg">
                                    {{ currPage }}
                                </span>
                                <a @click="prevPages(prevPage)"
                                    class="cursor-pointer text-sm md:text-base lg:text-xl text-dark text-opacity-70 hover:text-opacity-100 hover:shadow-sm">
                                    <PhCaretRight />
                                </a>
                            </div>
