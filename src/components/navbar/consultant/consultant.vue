<template>
    ...
    <div class="relative">
        <button class="
                ...
                @click="toggleFilter('reservasi-gim')"
                ref="dropdownReservasiRef"
            >
                <PhCalendar :size="24" weight="duotone" :class="{'text-light': $route.name == 'consultant.views.permintaan' || $route.name == 'consultant.views.jadwal','text-biru hover:text-light': $route.name !== 'consultant.views.permintaan' && $route.name !== 'consultant.views.jadwal'}" />
            Reservasi GIM
            <PhCaretDown :size="16"/>
        </button>
        <div v-if="dropdownReservasi"
            ...
            <div class="py-1" role="none">
            <!-- Active: "bg-gray-100 text-gray-900", Not Active: "text-gray-700" -->
            <RouterLink :to="{name: 'consultant.views.permintaan'}" class="cursor-pointer font-myFont hover:bg-neutral-200 text-gray-700 block px-4 py-2 text-sm" role="menuitem" tabindex="-1">
                Permintaan Reservasi
            </RouterLink>
            <RouterLink :to="{name: 'consultant.views.jadwal'}" class="cursor-pointer font-myFont hover:bg-neutral-200 text-gray-700 block px-4 py-2 text-sm" role="menuitem" tabindex="-1">
                Jadwal Reservasi
            </RouterLink>
            </div>
        </div>
    ...
    class="
        ...
        >
        <PhExam :size="24" weight="regular" :class="{'text-light': $route.name == 'consultant.views.assessments','text-biru hover:text-light': $route.name !== 'consultant.views.assessments'}" />
        List Assessment
    </RouterLink>
