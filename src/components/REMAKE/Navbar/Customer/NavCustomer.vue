<template>
    <ul class="flex space-x-8">
        <li @click="goTo('views.dashboard')" class="relative group cursor-pointer">
            ...
            <div v-if="$route.name == 'views.dashboard'"
        ...
        <li class="relative cursor-pointer" @mouseenter="openSubmenu(2)" @mouseleave="scheduleCloseSubmenu(2)">
            <div class="flex items-center gap-[6px]">
                <img class="transition-all duration-100" :class="{
                    'grayscale': activeMenu !== 2 || $route.name !== 'user.views.deteksi'
            ...
            <ul v-show="activeMenu === 2"
                class="p-2 transition-all duration-500 absolute top-12 left-0 mt-2 w-48 bg-white text-black shadow-lg rounded-xl">
                ...
                <li @click="goTo('user.views.assesment')"
                ...
                <li v-if="cekTypeSekolah.is_student === 0 || (cekTypeSekolah.institutions && cekTypeSekolah.institutions.type !== 'SD' && cekTypeSekolah.institutions.type !== 'TK')"
                    @click="goTo('user.views.iq')"
                    class="hover:cursor-pointer group text-sm text-[#667085] px-[10px] py-[12px] rounded-lg hover:bg-[#F0F7FD] hover:text-black">
                    <div class="pl-3 flex items-center gap-3">
                        <img class="transition-all duration-100 grayscale group-hover:grayscale-0"
                ...
                <li @click="goTo('user.views.test_gadget')"
                    class="hover:cursor-pointer group text-sm text-[#667085] px-[10px] py-[12px] rounded-lg hover:bg-[#F0F7FD] hover:text-black">
                    <div class="pl-3 flex items-center gap-3">
                        <img class="transition-all duration-100 grayscale group-hover:grayscale-0"
                ...
                <li @click="goTo('user.views.test_kebahagiaan')"
                    class="hover:cursor-pointer group text-sm text-[#667085] px-[10px] py-[12px] rounded-lg hover:bg-[#F0F7FD] hover:text-black">
                    <div class="pl-3 flex items-center gap-3">
                ...
                <li v-if="cekTypeSekolah.institutions && (cekTypeSekolah.institutions.type == 'SD' || cekTypeSekolah.institutions.type == 'TK')"
                    @click="goTo('user.views.cpm')"
                    class="hover:cursor-pointer group text-sm text-[#667085] px-[10px] py-[12px] rounded-lg hover:bg-[#F0F7FD] hover:text-black">
                    <div class="pl-3 flex items-center gap-3">
                        <img class="transition-all duration-100 grayscale group-hover:grayscale-0"
        ...
        <li class="relative cursor-pointer" @mouseenter="openSubmenu(3)" @mouseleave="scheduleCloseSubmenu(3)">
            ...
            <ul v-show="activeMenu === 3"
                ...
                <li @click="goTo('user.views.hasil_assessment')"
                    class="hover:cursor-pointer group text-sm text-[#667085] px-[10px] py-[12px] rounded-lg hover:bg-[#F0F7FD] hover:text-black">
                    <div class="pl-3 flex items-center gap-3">
                        <img class="transition-all duration-100 grayscale group-hover:grayscale-0"
                            src="@/assets/icons/tes-assesment.svg" />
                ...
                <li v-if="cekTypeSekolah.is_student === 0 || (cekTypeSekolah.institutions && cekTypeSekolah.institutions.type !== 'SD' && cekTypeSekolah.institutions.type !== 'TK')"
                    @click="goTo('user.views.hasil_iq')"
                    class="hover:cursor-pointer group text-sm text-[#667085] px-[10px] py-[12px] rounded-lg hover:bg-[#F0F7FD] hover:text-black">
                    <div class="pl-3 flex items-center gap-3">
                        <img class="transition-all duration-100 grayscale group-hover:grayscale-0"
                            src="@/assets/icons/tes-iq.svg" />
                ...
                <li @click="goTo('user.views.hasil_rmib')"
                    class="hover:cursor-pointer group text-sm text-[#667085] px-[10px] py-[12px] rounded-lg hover:bg-[#F0F7FD] hover:text-black">
                    <div class="pl-3 flex items-center gap-3">
                        <img class="transition-all duration-100 grayscale group-hover:grayscale-0"
                            src="@/assets/icons/test-rmib.svg" />
                ...
                <li @click="goTo('user.views.hasil_gadget')"
                    class="hover:cursor-pointer group text-sm text-[#667085] px-[10px] py-[12px] rounded-lg hover:bg-[#F0F7FD] hover:text-black">
                    <div class="pl-3 flex items-center gap-3">
                        <img class="transition-all duration-100 grayscale group-hover:grayscale-0"
                            src="@/assets/icons/test-iaa.svg" />
                ...
                <li @click="goTo('user.views.hasil_bahagia')"
                    class="hover:cursor-pointer group text-sm text-[#667085] px-[10px] py-[12px] rounded-lg hover:bg-[#F0F7FD] hover:text-black">
                    <div class="pl-3 flex items-center gap-3">
                        <img class="transition-all duration-100 grayscale group-hover:grayscale-0 h-6 w-6"
                            src="@/assets/icons/tik_Overlay.svg" />
                ...
                <li v-if="cekTypeSekolah.institutions && (cekTypeSekolah.institutions.type == 'SD' || cekTypeSekolah.institutions.type == 'TK')"
                    @click="goTo('user.views.hasil_cpm')"
                    class="hover:cursor-pointer group text-sm text-[#667085] px-[10px] py-[12px] rounded-lg hover:bg-[#F0F7FD] hover:text-black">
                    <div class="pl-3 flex items-center gap-3">
                        <img class="transition-all duration-100 grayscale group-hover:grayscale-0"
                            src="@/assets/icons/tes-cpm.svg" />
