    ...
    <nav class="w-full mx-[50px] flex justify-between items-center gap-4">
      ...
      >
        ...
        <img
          v-if="userDatas && userDatas.customer.image !== null"
          class="w-9 h-9 rounded-full"
          :src="baseUrl + 'open/customers/' + userDatas.customer.image"
        />
  ...
  >
    <div id="tabs" class="flex justify-between">
      ...
      >
          ...
          <img
            :class="{
              'grayscale group-hover:grayscale-0':
                $route.name !== 'views.dashboard',
              'grayscale-0': $route.name == 'views.dashboard',
            }"
        ...
        <span
          :class="{
            'text-[#667085]': $route.name !== 'views.dashboard',
            'text-black font-medium': $route.name == 'views.dashboard',
          }"
          class="font-roboto block text-xs"
          >Beranda</span
        >
      </RouterLink>
