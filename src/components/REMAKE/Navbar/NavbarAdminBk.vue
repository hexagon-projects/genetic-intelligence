<template>
  ...
  >
    <nav class="w-full mx-[50px] flex justify-between items-center gap-4">
      ...
      <ul class="flex space-x-8">
        <li
          @click="goTo('amdinbk.views.dashboard')"
        ...
        <li
          @click="goTo('amdinbk.views.anggota')"
          class="relative group cursor-pointer"
        >
          <div class="flex items-center gap-[6px]">
            <img
  ...
  >
    <div id="tabs" class="flex justify-between">
      <RouterLink
        :to="{ name: 'amdinbk.views.dashboard' }"
      ...
      >
        ...
        <span class="tab tab-home block text-xs">Anggota</span>
      </RouterLink>
    </div>
  </section>
</template>
